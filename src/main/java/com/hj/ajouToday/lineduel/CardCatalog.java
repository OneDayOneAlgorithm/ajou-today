...
public class CardCatalog {
    ...
    private final Map<Integer, Card> cards = Map.of(
            1, new Card(1, "병사", CardType.UNIT, 1, 2, 2, "기본 유닛"),
            2, new Card(2, "방패병", CardType.UNIT, 2, 1, 5, "체력이 높다"),
            3, new Card(3, "광전사", CardType.UNIT, 2, 4, 1, "공격력이 높다"),
            4, new Card(4, "화염구", CardType.SPELL, 3, 3, 0, "상대 영웅에게 3 피해")
    );
